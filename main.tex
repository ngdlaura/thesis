...
\newboolean{skipIntro}
\newboolean{skipRelated0}
\newboolean{skipRelated1}
\newboolean{skipRelated2}
\newboolean{skipRelated3}
\newboolean{skipCh3}
\newboolean{skipCh4}
\newboolean{skipCh5}
...
\begin{document}
	...
	\acresetall
	\input{02_0_related.tex} 
	\cleardoublepage
	\let\leftmark=\oldleftmark

	\acresetall
	\input{02_1_related.tex} 
	\cleardoublepage
	\let\leftmark=\oldleftmark

	\acresetall
	\input{02_2_related.tex} 
	\cleardoublepage
	\let\leftmark=\oldleftmark

	\acresetall
	\input{02_3_related.tex} 
	\cleardoublepage
	\let\leftmark=\oldleftmark
	
	\acresetall
	\input{03_chapter3.tex}
	\cleardoublepage
	\let\leftmark=\oldleftmark

	\acresetall
	\input{04_chapter4.tex}
	\cleardoublepage
	\let\leftmark=\oldleftmark

        \acresetall
	\input{05_chapter5.tex}
	\cleardoublepage
	\let\leftmark=\oldleftmark
	...
	\appendix
	\acresetall
	\input{10_appendix1.tex}
	\cleardoublepage

	\acresetall
	\input{11_appendix2.tex}
	\cleardoublepage
